...
The conversion was done with [linux-cursor-to-windows-converter](https://github.com/Anshitas-12/linux-cursor-to-windows-converter), a small Python tool that reads the theme's SVG source and per-cursor hotspot config directly, rather than guessing.
